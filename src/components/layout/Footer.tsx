        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <div className="flex flex-col mb-6">
              ...
              <span className="text-xs tracking-[0.2em] font-medium text-amber-500">NATURE WORKS</span>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-6 border-b border-amber-600/30 pb-2 inline-block">Quick Links</h4>
          ...
          {/* Products */}
          <div>
            <h4 className="text-lg font-bold mb-6 border-b border-amber-600/30 pb-2 inline-block">Our Products</h4>
            <ul className="space-y-4 text-gray-400">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold mb-6 border-b border-amber-600/30 pb-2 inline-block">Contact</h4>
            <ul className="space-y-4 text-gray-400">
