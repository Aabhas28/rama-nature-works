        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <ScrollReveal key={feature.id} animation="fade-up" delay={index * 150}>
              <div
                className="group relative bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:border-amber-600/50 transition-all hover:bg-white/10 h-full"
              >
                {/* Icon Placeholder */}
